...
namespace GameUtilities
{
    public class Menu : DrawableGameComponent
    {
        ...
        public Menu(TextField t, Game g)
            : base(g)
        {
            menuButtons = new List<MenuButton>();
            bodyText = new List<TextField>();
            textures = new List<Texture2D>();
            animatedTextures = new List<AnimatedTexture>();
            title = t;
        ...
        public virtual void AddMenuAnimatedTexture(AnimatedTexture t)
        {
        ...
        public void DrawMenu(SpriteBatch spriteBatch, GraphicsDeviceManager graphics, SpriteFont titleFont, SpriteFont textFont)
        {
            ...
            foreach (AnimatedTexture t in animatedTextures)
            {
                spriteBatch.Draw(t.Texture, t.Position, null, Color.White, t.Angle, t.Origin, 1.0f, SpriteEffects.None, 0.0f);
            }
        }
        ...
        /// <summary>
        /// Get the number of textures in the menu.  Does not include animated textures.
        /// </summary>
        ...
        /// <summary>
        /// Get the number of animated textures in menu
        /// </summary>
        public int AnimatedTextureCount
        {
            get
            {
                return animatedTextures.Count;
            }
        }
        ...
        public int TotalObjectCount
        {
            get
            {
                return ButtonCount + TextFieldCount + AnimatedTextureCount + TextureCount;
            }
        }
